package JavaPracticeDay_14MarketProjesi;
...
public class JavaMarket {
    static List<String> urunler = new ArrayList<>(Arrays.asList("Domates", "Patates", "Biber", "Sogan", "HavuÃ§", "Elma", "Muz", "Ã‡ilek", "Kavun", "ÃœzÃ¼m", "Limon"));
