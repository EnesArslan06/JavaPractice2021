...
public class Q03 {
    ...
    char ilkharf=adAd2Soyad.toUpperCase().charAt(0);
    char ikinciharf=adAd2Soyad.toUpperCase().charAt(adAd2Soyad.indexOf(" ")+1);
    char ucuncuharf=adAd2Soyad.toUpperCase().charAt(adAd2Soyad.lastIndexOf(" ")+1);
    System.out.println("İsminizin Bas HArfleri: " + ilkharf+ikinciharf+ucuncuharf );
    }
}
